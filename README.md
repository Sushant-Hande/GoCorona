...
- [RxJava](https://github.com/ReactiveX/RxJava/tree/2.x) - The library for composing asynchronous and event-based programs using observable sequences for the JVM.  
